...
- [Step-by-step tutorial on the usage of mesounitR](vignettes/usage_tutorial.Rmd)
...
Please refer to the following for in-depth descriptions of the methodology and software:

- Farò, D., Baumgartner, K., Vezza, P., & Zolezzi, G. (2022). A novel unsupervised method for assessing mesoscale river habitat structure and suitability from 2D hydraulic models in gravel-bed rivers. Ecohydrology, 15(7), e2452. https://doi.org/10.1002/eco.2452
