...
poly_mesoHABSIM <- add_refugia(poly_mesohabitats, 
                               flow_ZDV,
...
# poly_mesoHABSIM_filled <- smoothr::fill_holes(poly_mesoHABSIM,threshold=10000)

# extract depth, velocity, substrate and save to .txt
# DEPTH and VEL values should be in m and m/s
table_DVS <- extract_DVS(poly_mesoHABSIM, flow_ZDV, depth_min = 0.05, ras_substrate, sub_codes, file_name='mesohabitats_DVS.txt')
